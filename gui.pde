...
public void createGUI(){
  ...
  PencilButton = new GButton(window1, 20, 15, 80, 30);
  PencilButton.setText("Pencil");
  PencilButton.addEventHandler(this, "PencilButtonClick");
  EraserButton = new GButton(window1, 140, 15, 80, 30);
  EraserButton.setText("Eraser");
  EraserButton.addEventHandler(this, "EraserButtonClick");
  ToolSlider = new GCustomSlider(window1, 68, 55, 100, 40, "grey_blue");
